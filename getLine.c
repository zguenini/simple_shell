...
/**
 * Function to buffer chained commands.
 *
 * @param info Parameter struct
 * @param buf Address of the buffer
 * @param len Address of the len var
 * @return Bytes read
 */
...
/**
 * Function to get a line minus the newline.
 *
 * @param info Parameter struct
 * @return Bytes read
 */
...
/**
 * Function to get the next line of input from STDIN.
 *
 * @param info Parameter struct
